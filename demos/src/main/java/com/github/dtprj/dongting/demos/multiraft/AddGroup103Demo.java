...
public class AddGroup103Demo implements GroupId {
    public static void main(String[] args) throws Exception {
        ...
        CompletableFuture<Void> f1 = adminClient.serverAddGroup(
                1, GROUP_ID_103, "1,2,3", "", timeout);
        CompletableFuture<Void> f2 = adminClient.serverAddGroup(
                2, GROUP_ID_103, "1,2,3", "", timeout);
        CompletableFuture<Void> f3 = adminClient.serverAddGroup(
                3, GROUP_ID_103, "1,2,3", "", timeout);
        f1.get();
        f2.get();
        f3.get();
